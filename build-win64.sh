...
cp native/build-x64/src/Release/Pyron.exe build/win-x64/
cp target/Pyron.jar build/win-x64/
...
echo Pyron.exe 64bit sha256sum
sha256sum build/win-x64/Pyron.exe

dumpbin //HEADERS build/win-x64/Pyron.exe

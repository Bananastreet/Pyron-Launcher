...
cp native/build-x86/src/Release/Pyron.exe build/win-x86/
cp target/Pyron.jar build/win-x86/
...
echo Pyron.exe 32bit sha256sum
sha256sum build/win-x86/Pyron.exe

dumpbin //HEADERS build/win-x86/Pyron.exe
